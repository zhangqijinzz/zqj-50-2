...
export const RECIPES: Recipe[] = [
  {
    ...
    coverEmoji: '🍳',
    requiredIngredients: [
      { id: 'v-tomato', amount: 2 },
      { id: 'p-egg', amount: 3 },
      { id: 'se-salt', amount: 0 },
      { id: 'se-oil', amount: 0 },
      { id: 'se-sugar', amount: 0 },
    ],
    steps: [
      '番茄切块，鸡蛋打散加少许盐',
      '热锅冷油，倒入蛋液炒至凝固盛出',
  ...
  },
  {
    ...
    coverEmoji: '🥔',
    requiredIngredients: [
      { id: 'v-pepper', amount: 2 },
      { id: 'v-potato', amount: 2 },
      { id: 'se-salt', amount: 0 },
      { id: 'se-vinegar', amount: 0 },
      { id: 'se-oil', amount: 0 },
      { id: 'v-garlic', amount: 0 },
    ],
    steps: [
      '土豆去皮切细丝，泡水洗去淀粉',
      '青椒切丝，大蒜切末',
  ...
  },
  {
    ...
    coverEmoji: '🥦',
    requiredIngredients: [
      { id: 'v-broccoli', amount: 1 },
      { id: 'v-garlic', amount: 0 },
      { id: 'se-salt', amount: 0 },
      { id: 'se-oil', amount: 0 },
      { id: 'se-oyster', amount: 0 },
    ],
    steps: [
      '西兰花切小朵，盐水浸泡10分钟',
      '大蒜剁成蒜蓉',
  ...
  },
  {
    ...
    coverEmoji: '🍚',
    requiredIngredients: [
      { id: 's-rice', amount: 250 },
      { id: 'p-egg', amount: 2 },
      { id: 'v-green-onion', amount: 1 },
      { id: 'se-salt', amount: 0 },
      { id: 'se-oil', amount: 0 },
    ],
    steps: [
  ...
  },
  {
    ...
    coverEmoji: '🥒',
    requiredIngredients: [
      { id: 'v-cucumber', amount: 1 },
      { id: 'v-fungus', amount: 0.3 },
      { id: 'v-garlic', amount: 0 },
      { id: 'se-vinegar', amount: 0 },
      { id: 'se-soy', amount: 0 },
      { id: 'se-sesame', amount: 0 },
    ],
    steps: [
      '木耳提前泡发，焯水1分钟过凉水',
      '黄瓜拍碎切段',
  ...
  },
  {
    ...
    requiredIngredients: [
      { id: 'v-potato', amount: 2 },
      { id: 'p-beef', amount: 250 },
      { id: 'v-carrot', amount: 1 },
      { id: 'v-onion', amount: 0.5 },
      { id: 'v-garlic', amount: 0 },
      { id: 'se-soy', amount: 0 },
      { id: 'se-oil', amount: 0 },
      { id: 'se-salt', amount: 0 },
  ...
  },
  {
    ...
    coverEmoji: '🍗',
    requiredIngredients: [
      { id: 'p-chicken', amount: 200 },
      { id: 'v-mushroom', amount: 150 },
      { id: 'v-green-onion', amount: 1 },
      { id: 'v-garlic', amount: 0 },
      { id: 'se-soy', amount: 0 },
      { id: 'se-oil', amount: 0 },
  ...
  },
  {
    ...
    coverEmoji: '🍜',
    requiredIngredients: [
      { id: 'v-cabbage', amount: 0.5 },
      { id: 's-noodle', amount: 1 },
      { id: 'p-egg', amount: 1 },
      { id: 'v-green-onion', amount: 1 },
      { id: 'v-garlic', amount: 0 },
      { id: 'se-soy', amount: 0 },
  ...
  },
  {
    ...
    coverEmoji: '🍜',
    requiredIngredients: [
      { id: 's-instant-noodle', amount: 1 },
      { id: 'p-egg', amount: 1 },
      { id: 'v-green-onion', amount: 1 },
      { id: 'v-cabbage', amount: 0.25 },
      { id: 'p-sausage', amount: 0.5 },
    ],
    steps: [
      '火腿肠切片，白菜切丝',
      '水烧开，下面饼和调料包',
  ...
  },
  {
    ...
    coverEmoji: '🥑',
    requiredIngredients: [
      { id: 'v-avocado', amount: 1 },
      { id: 'p-egg', amount: 1 },
      { id: 's-bread', amount: 0.5 },
      { id: 'se-salt', amount: 0 },
      { id: 'se-pepper', amount: 0 },
    ],
    steps: [
      '面包片烤至金黄',
      '牛油果切片，鸡蛋煎熟',
  ...
  },
  {
    ...
    coverEmoji: '🍆',
    requiredIngredients: [
      { id: 'v-eggplant', amount: 1 },
      { id: 'v-potato', amount: 1 },
      { id: 'v-pepper', amount: 1 },
      { id: 'v-garlic', amount: 0 },
      { id: 'se-soy', amount: 0 },
      { id: 'se-vinegar', amount: 0 },
      { id: 'se-sugar', amount: 0 },
  ...
  },
  {
    ...
    requiredIngredients: [
      { id: 'p-tofu', amount: 1 },
      { id: 'p-pork', amount: 150 },
      { id: 'v-garlic', amount: 0 },
      { id: 'se-ginger', amount: 0 },
      { id: 'se-sauce', amount: 0 },
      { id: 'se-soy', amount: 0 },
      { id: 'se-oil', amount: 0 },
      { id: 'se-starch', amount: 0 },
      { id: 'se-pepper', amount: 0 },
  ...
  },
  {
    ...
    coverEmoji: '🥟',
    requiredIngredients: [
      { id: 's-dumpling', amount: 0.5 },
      { id: 'v-green-onion', amount: 0 },
      { id: 'se-vinegar', amount: 0 },
      { id: 'se-soy', amount: 0 },
      { id: 'se-sesame', amount: 0 },
    ],
  ...
  },
  {
    ...
    requiredIngredients: [
      { id: 's-bread', amount: 0.5 },
      { id: 'p-bacon', amount: 0.5 },
      { id: 'p-cheese', amount: 0 },
      { id: 'p-egg', amount: 1 },
    ],
    steps: [
      '面包片用勺子压出凹槽',
  ...
  },
  {
    ...
    coverEmoji: '🥬',
    requiredIngredients: [
      { id: 'v-celery', amount: 1 },
      { id: 'p-beef', amount: 200 },
      { id: 'v-garlic', amount: 0 },
      { id: 'se-soy', amount: 0 },
      { id: 'se-oil', amount: 0 },
      { id: 'se-starch', amount: 0 },
